...
// CHECK: C2. Selecciona los elementos del DOM necesarios con const
...
// CHECK: C3. Declara una función nombrada para procesar el saludo
function generarSaludo() {
    ...
    if (nombre === "") {
        ...
        mensajeResultado.textContent = "¡Hola, " + nombre + "! Bienvenido al Panel Interactivo UETS.";
    }
}

// CHECK: C4 y C5. Agrega los eventos addEventListener para actualizar la pantalla
